$(document).ready(function(){
  ...
  function initMap() {
    ...
    L.tileLayer('https://api.mapbox.com/styles/v1/mapbox/streets-v11/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoiaDB3YXJkY2gzbmciLCJhIjoiY2syc3Zod2x5MTRyZTNvcXY3dTQ2NHFkZSJ9.eChSWdg1CZBnQCwQi3xz0Q', {
      maxZoom: 18,
      zoomControl: false,
      minZoom:3,
      noWrap: true
